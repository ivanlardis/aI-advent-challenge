...
- [ ] T-09 | refactor | Вынести константу `DEFAULT_USER_NAME = "Пользователь"` в `lib/profile.py` на уровень модуля. Заменить все литералы `"Пользователь"` в этом модуле на константу. — **Acceptance:** константа объявлена; литералов в теле модуля не осталось; существующие тесты зелёные.
